...
def test_extract_features(mock_sequence):
    ...
    expected_features = {
        ...
        "10th_percentile_intensity": np.percentile(mock_sequence, 10),
        "90th_percentile_intensity": np.percentile(mock_sequence, 90),
...
def test_extract_features_flat_sequence(mock_flat_sequence):
    ...
    expected_features = {
        ...
        "10th_percentile_intensity": np.percentile(mock_flat_sequence, 10),
        "90th_percentile_intensity": np.percentile(mock_flat_sequence, 90),
